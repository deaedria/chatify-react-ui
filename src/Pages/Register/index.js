        ...
        <div className="container">
            <div className="form-box">
                ...
                <form onSubmit={(e) => onSubmit(e)} className="form-register" autoComplete="off">
                    ...
                    <div className="form-register-group">
                        <input type="email" data-testid="email-register" id="email-register" name="email" required onChange={(e) => {
                            setFormData({ ...formData, email: e.target.value })
                        }} />
                        <label htmlFor="input-field">Email</label>
                    </div>
                    <div className="form-register-group">
                        <input type="password" data-testid="password-register" id="password-register" name="password" required onChange={(e) => {
